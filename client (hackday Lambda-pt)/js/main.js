...
var _krisajenkins$elm_cdn$CDN$wing = {
	css: _krisajenkins$elm_cdn$CDN$stylesheet('https://cdnjs.cloudflare.com/ajax/libs/wingcss/0.1.9/wing.min.css')
};
var _krisajenkins$elm_cdn$CDN$bass = {
	css: _krisajenkins$elm_cdn$CDN$stylesheet('https://unpkg.com/basscss@8.0.2/css/basscss.min.css')
};
var _krisajenkins$elm_cdn$CDN$pure = {
	css: _krisajenkins$elm_cdn$CDN$stylesheet('http://yui.yahooapis.com/pure/0.6.0/pure-min.css')
};
...
var _user$project$Types$SetColor = function (a) {
	return {ctor: 'SetColor', _0: a};
};
var _user$project$Types$SetName = function (a) {
	return {ctor: 'SetName', _0: a};
};
var _user$project$Types$KeepAlive = {ctor: 'KeepAlive'};
var _user$project$Types$Receive = function (a) {
	return {ctor: 'Receive', _0: a};
};
var _user$project$Types$GameMsg = function (a) {
	return {ctor: 'GameMsg', _0: a};
};

var _user$project$State$decodeCoords = A3(
...
var _user$project$State$decodeGps = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'position',
	_user$project$State$decodeCoords,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'distance',
		_elm_lang$core$Json_Decode$float,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Types$Gps)));
var _user$project$State$decodePlayer = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'color',
...
var _user$project$State$decodeBoard = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'players',
	_elm_lang$core$Json_Decode$list(_user$project$State$decodePlayer),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'gpss',
		_elm_lang$core$Json_Decode$list(_user$project$State$decodeGps),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Types$Board)));
var _user$project$State$encodeGameMsg = function (msg) {
...
var _user$project$State$init = {ctor: '_Tuple2', _0: _krisajenkins$remotedata$RemoteData$NotAsked, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$State$websocketEndpoint = 'ws://94.60.163.141:8000';
			...
			default:
				return {
					...
					_1: A2(
						...
						_user$project$State$websocketEndpoint,
						A2(
							_elm_lang$core$Json_Encode$encode,
							0,
							_user$project$State$encodeGameMsg(_p2._0)))
				};
		}
	});
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: A2(
				...
				_user$project$State$websocketEndpoint,
				function (_p3) {
					return _user$project$Types$Receive(
						_krisajenkins$remotedata$RemoteData$fromResult(
							A2(_elm_lang$core$Json_Decode$decodeString, _user$project$State$decodeBoard, _p3)));
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$core$Platform_Sub$map,
					_elm_lang$core$Basics$always(_user$project$Types$KeepAlive),
					_elm_lang$websocket$WebSocket$keepAlive(_user$project$State$websocketEndpoint)),
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$View_Scene$gpsView = function (gps) {
	return A2(
		_elm_lang$svg$Svg$g,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$svg$Svg$circle,
				{
					...
					_0: _elm_lang$svg$Svg_Attributes$cx(
						_elm_lang$core$Basics$toString(gps.position.x)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$cy(
							_elm_lang$core$Basics$toString(gps.position.y)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$r('0.25'),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$fill('green'),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$style('transition: all 1s'),
									_1: {ctor: '[]'}
								}
							}
						}
						...
						_1: {
							...
							_1: {
								...
								_0: _elm_lang$svg$Svg_Attributes$r(
									_elm_lang$core$Basics$toString(gps.distance)),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$opacity('0.6'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$stroke('#0697e8'),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$strokeDasharray('1'),
											_1: {
												ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_0: _elm_lang$svg$Svg_Attributes$from(
													A4(_krisajenkins$formatting$Formatting$print, formatRotation, 0, gps.position.x, gps.position.y)),
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$to(
														A4(_krisajenkins$formatting$Formatting$print, formatRotation, 360, gps.position.x, gps.position.y)),
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$dur('10s'),
														_1: {
															ctor: '::',
...
var _user$project$View_Scene$playerView = function (player) {
	return A2(
		_elm_lang$svg$Svg$circle,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$cx(
				_elm_lang$core$Basics$toString(player.position.x)),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$cy(
					_elm_lang$core$Basics$toString(player.position.y)),
				_1: {
					ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: _elm_lang$svg$Svg_Attributes$fill(
										A2(_elm_lang$core$Maybe$withDefault, 'white', player.color)),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$style('transition: all 200ms'),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$View_Scene$root = function (board) {
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$width('70vw'),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$height('70vh'),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$viewBox('-30 -30 60 60'),
					_1: {ctor: '[]'}
				}
			}
		},
		{
			...
			_0: A2(
				_elm_lang$svg$Svg$g,
				{ctor: '[]'},
				A2(_elm_lang$core$List$map, _user$project$View_Scene$playerView, board.players)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$svg$Svg$g,
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$View_Scene$gpsView, board.gpss)),
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$View$controls = function () {
	var simpleButton = F2(
		function (label, msg) {
			return A2(
	...
	return A2(
		...
		A2(
			_elm_lang$core$List$map,
			_elm_lang$core$Basics$uncurry(simpleButton),
			{
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'Set Name',
					_1: _user$project$Types$SetName('Kris')
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'Set Color',
						_1: _user$project$Types$SetColor('#0000ff')
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'Left',
							_1: _user$project$Types$Move(
								A2(_user$project$Types$Coords, -1.0, 0))
						},
						_1: {
							ctor: '::',
							_0: {
...
var _user$project$View$playerView = function (player) {
	return A2(
							...
							_1: {
								...
								_1: {
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'background-color',
										_1: A2(_elm_lang$core$Maybe$withDefault, 'white', player.color)
									},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'transition', _1: 'all 1s'},
										_1: {
											ctor: '::',
...
var _user$project$View$playerList = function (players) {
	return A2(
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$View_Scene$root(board),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$View$playerList(board.players),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$View$heading = A2(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Triangulation!'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(_elm_lang$html$Html$map, _user$project$Types$GameMsg, _user$project$View$controls),
			_1: {ctor: '[]'}
		}
	});
...
var _user$project$View$root = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _krisajenkins$elm_cdn$CDN$bootstrap.css,
			_1: {
				ctor: '::',
				_0: _user$project$View$heading,
				_1: {
					ctor: '::',
					_0: A2(_user$project$View$remoteDataView, _user$project$View$boardView, model),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$App$main = _elm_lang$html$Html$program(
	{init: _user$project$State$init, view: _user$project$View$root, update: _user$project$State$update, subscriptions: _user$project$State$subscriptions})();
